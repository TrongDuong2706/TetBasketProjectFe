    ...
    <div className='w-full'>
      ...
      <section className='bg-[#fff8f1] text-black py-10 text-center'>
        <div className='max-w-6xl mx-auto px-4'>
          ...
          <p className='text-xl'>
            Hãy để Luxy Box đồng hành cùng bạn trong việc trao gửi những món quà ý nghĩa, thể hiện sự quan tâm và kết
            nối tình thân với những người thân yêu, đối tác và khách hàng.
          </p>
